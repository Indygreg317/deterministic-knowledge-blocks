...
| Schema validation reports | Record manifest checks, artifact case results, expected-invalid behavior, summary counts, and failures. | `schema/schema-validation-report.schema.json`; `docs/schema-validation-reports.md`; `validation/reports/schema-validation-report.json`; generated by `reference-implementation/python/validate_artifact_schemas.py --save-report` | Present | Includes a persisted example report and CI-generated temporary report artifact. |
