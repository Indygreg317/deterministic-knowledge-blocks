...
| Schema validation reports | Record manifest checks, artifact case results, expected-invalid behavior, summary counts, and failures. | `schema/schema-validation-report.schema.json`; `docs/schema-validation-reports.md`; generated by `reference-implementation/python/validate_artifact_schemas.py --save-report` | Present | CI generates a temporary report artifact to exercise report output. |
