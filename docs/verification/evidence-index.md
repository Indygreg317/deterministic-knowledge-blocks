...
| Governance record concept | Documents governance records as declaration artifacts and distinguishes declaration from verification. | `docs/governance-records.md` | Present | Documentation concept only; no schema, example, validation case, or certification claim is introduced. |
