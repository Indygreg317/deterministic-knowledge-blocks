...
- validate known artifacts against repository schemas
...
A lightweight dependency-free check that validates known repository artifacts against their corresponding schemas using the subset of JSON Schema currently used by the project.
...
- validates known artifacts against repository schemas
